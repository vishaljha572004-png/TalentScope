...
Resume: ${safeResume}
    ...
    const modeInstructions = mode === "HR"
      ? `Focus on behavioral, situational, and communication-based questions.
         Ask about teamwork, leadership, conflict resolution, strengths, weaknesses, and career goals.
         Questions should feel like a real HR round in a top company.`
      : `Focus on technical theory questions based on the candidate's role, skills, and experience.
         Ask about concepts, fundamentals, system design, and problem-solving approaches.
         Do NOT ask coding problems. Ask verbal/conceptual technical questions only.`;
...
finalScore = average of confidence, communication, and correctness (rounded).

Feedback Rules:
- Natural human feedback, 10 to 15 words only.
